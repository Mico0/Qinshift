...
const fakeShop = (function () {
    ...
    function addNavigationEEventListeners() {
        // Home page
        document.getElementById(navigationIds.home).addEventListener('click', function() {
            document.getElementById('shop').style.display = 'none';
            document.getElementById('cart').style.display = 'none';
        });
        //Products
        document.getElementById(navigationIds.products).addEventListener('click', function() {
        ...
        // Cart
        document.getElementById(navigationIds.cart).addEventListener('click', function() {
