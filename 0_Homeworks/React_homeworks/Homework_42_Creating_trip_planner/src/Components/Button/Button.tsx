    ...
    chosenIcon = (
      ...
      >
        <g fillRule="evenodd" clipRule="evenodd">
          ...
          <path
            fill="#FC3435"
            d="M32 42c-8.836 0-16-7.164-16-16 0-1.433.209-2.814.562-4.139a3.94 3.94 0 0 1 .228-.574 4 4 0 0 1 5.392-1.714c.041.021.068.015.104.026A3.938 3.938 0 0 0 24 20a3.965 3.965 0 0 0 2.621-1.001l.014.017A1.978 1.978 0 0 1 28 18.468a2 2 0 0 1 2 2 1.99 1.99 0 0 1-1.011 1.729 7.957 7.957 0 0 1-8.618.893A12.015 12.015 0 0 0 20 26c0 6.628 5.372 12 12 12s12-5.372 12-12-5.372-12-12-12c-.582 0-1.151.056-1.709.141l-.008-.044c-.092.013-.187.029-.283.029a2 2 0 0 1 0-4c.029 0 .056.007.085.007A15.707 15.707 0 0 1 32 10c8.836 0 16 7.164 16 16s-7.164 16-16 16z"
          />
        </g>
      </svg>
    );
