...
function TripPanel({ country }: TripPanelProps) {
  ...
  return (
    <div className="p-2 flex items-center justify-center gap-4 flex-col text-center sm:justify-between ">
      <div className="flex flex-col sm:flex-row items-center justify-center gap-1 md:gap-4">
        ...
        <Button onClick={() => removeFromTripPlanner(country)} icon="delete">
          Remove trip
        </Button>
      </div>
    </div>
